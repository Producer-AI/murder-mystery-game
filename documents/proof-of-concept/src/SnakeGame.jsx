...
const SnakeIcon = () => <span style={{ fontSize: "1.2em" }}>🐍</span>;

const HorseEmoji = () => <span style={{ fontSize: "1.2em" }}>🐎</span>;

const Lantern = () => <span style={{ fontSize: "1.4em" }}>🧧</span>;
...
export default function SnakeGameScreens() {
  ...
  const creamBg = {
    background:
      "linear-gradient(145deg, #FAF6F1 0%, #F5EDE4 50%, #FAF6F1 100%)",
  };

  const darkBg = {
    background:
      "linear-gradient(145deg, #1A0A0A 0%, #2D0F0F 30%, #1A0A0A 70%, #0D0505 100%)",
    color: "#D4A574",
  };

  const redBg = {
    background:
      "linear-gradient(145deg, #8B1A1A 0%, #A02020 30%, #8B1A1A 70%, #6B1010 100%)",
    color: "#FAF6F1",
  };
  ...
  const QuizScreen = () => (
    ...
    >
      ...
      <div
        style={{ textAlign: "center", zIndex: 1, maxWidth: 340, width: "100%" }}
      >
        <div
          style={{
            display: "flex",
              ...
              >
                <span
                  style={{
                    fontSize: 11,
                    width: 24,
                    color: i === 0 ? "#D4A574" : "rgba(212,165,116,0.3)",
                    fontFamily: "'Georgia', serif",
                  }}
                >
                  {i + 1}
  ...
  const EliminationScreen = () => (
    <div
      style={{ ...baseStyles, ...redBg, justifyContent: "center", padding: 40 }}
    >
  ...
  const PlayerCardScreen = () => (
    ...
    >
      ...
      <div
        style={{ textAlign: "center", zIndex: 1, maxWidth: 320, width: "100%" }}
      >
        <p
          style={{
            fontSize: 10,
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  padding: "8px 0",
                  borderBottom:
                    i < 5 ? "1px solid rgba(139,32,32,0.08)" : "none",
                }}
              >
                <span
                  style={{
                ...
                <span style={{ fontSize: 11, letterSpacing: 1 }}>{value}</span>
              </div>
            ))}
          </div>
        </div>
            ...
            {["✓", "✓", "✓", "✗", "✓", "✓", "✗"].map((mark, i) => (
              <div
                ...
                style={{
                  ...
                  background:
                    mark === "✓" ? "rgba(139,32,32,0.03)" : "transparent",
                }}
              >
                {mark}
              </div>
